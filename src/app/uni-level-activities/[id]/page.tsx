    ...
    <div className={styles.page}>
      <div className={styles.container}>
        ...
        <section className={styles.infoGrid}>
          ...
          <div className={styles.infoCard}>
            <div className={styles.infoLabel}><Clock size={16} /> وقت الفعالية</div>
            <div className={styles.infoValue}>{event.time}</div>
          </div>

          <div className={styles.infoCard}>
            <div className={styles.infoLabel}><CalendarDays size={16} /> تاريخ الفعالية</div>
            <div className={styles.infoValue} dir="ltr">{event.date}</div>
          </div>
        </section>
        ...
        {/* <section className={styles.block}>
          <div className={styles.blockTitle}>الوسائط</div>
          <div className={styles.mediaGrid}>
            <div className={styles.dropZone}>فيديوهات الفعالية</div>
            <div className={styles.dropZoneAlt}>صور الفعالية</div>
          </div>
        </section> */}
