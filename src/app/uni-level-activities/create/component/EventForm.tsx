...
useEffect(() => {
  ...
  async function fetchEvent() {
    ...
    setSelectedFacultyIds(data.faculty_ids || []);
  }
      ...
      <div className={styles.container}>
        <header className={styles.header}>
          <div className={styles.headerText}>
            ...
            <p className={styles.subtitle}> {isEditMode ? "قم بملء التفاصيل لتعديل الفعالية" : "قم بملء التفاصيل لإنشاء فعالية جديدة"}</p>
          </div>
